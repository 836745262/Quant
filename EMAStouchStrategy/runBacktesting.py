...
if __name__ == '__main__':
    ...
    # Bar回测
    engine.initStrategy(MultiStrategy, setting)
    ...
    # mp.addLine(line=chartLog[['EMA_short', 'EMA_long', 'CCI']].reset_index(), colors={"EMA_short": "green","EMA_long": "red",'CCI':'blue'}, pos=0)
    # mp.resample()
    # mp.show()