...
def setConfig(root=None):
    # 设置策略类
    optimize.strategyClass = MultiStrategy
    ...
    optimize.paramsSetting = {
            # "EMAfastPeriod": range(12,31,6),
            # "EMAslowPeriod": range(6,21,6),
            "slow_dPeriod": range(6,20,6),
            "fast_kPeriod": range(10,31,6),
            "slow_kPeriod": range(6,20,6),
    }
