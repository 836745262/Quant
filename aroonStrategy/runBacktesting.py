...
import json
import os
from AroonStrategy import AroonStrategy
...
if __name__ == '__main__':
    ...
    # Bar回测
    engine.initStrategy(AroonStrategy, setting)
    ...
    mp.addLine(line=chartLog[['aroonup', 'aroon', 'aroondown']].reset_index(), colors={"aroonup": "green","aroon": "red",'aroondown':'blue'})
    mp.resample()
    mp.show()